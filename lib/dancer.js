/*
 * dancer - v0.3.2-mod - 2020-06-28
 * https://github.com/jsantell/dancer.js
 * Copyright (c) 2020 Jordan Santell
 * Licensed MIT
 */
(function () {
  var Dancer = function () {
    ...
    load: function (source) {
      ...
      if (source.audio) {
        ...
        navigator.mediaDevices.getUserMedia(
          { audio: true }).then(this._userMediaCallback)
        this.source = source;
      }
  ...
  function update() {
    for (var i in this.sections) {
      if (this.sections[i].condition()) this.sections[i].callback.call(this);
    }
  }
...
(function() {
  ...
  function connectContext() {
    if (this.audio instanceof HTMLMediaElement) {
